...
#ifndef AVOID_GO_LEFT_SUB_HSM_H  // <- This should be changed to your own guard on both
#define AVOID_GO_LEFT_SUB_HSM_H  //    of these lines
...
/**
 * @Function InitAvoidGoLeftSubHSM(void)
