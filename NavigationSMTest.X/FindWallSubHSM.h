...
#ifndef FIND_WALL_SUB_HSM_H // <- This should be changed to your own guard on both
#define FIND_WALL_SUB_HSM_H //    of these lines
...
/**
 * @Function InitFindWallSubHSM(void)
